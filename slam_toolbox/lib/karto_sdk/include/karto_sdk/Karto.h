...
class PointGps : public Vector3<kt_double>
{
public:
    /**
     ...
     */
    PointGps(kt_double latitude, kt_double longitude, kt_double yaw)
    {
        SetX(longitude);
        SetY(latitude);
        SetZ(yaw);
...
public:
     ...
     * @param yaw new yaw
     */
    inline void SetYaw(kt_double yaw)
    {
        SetZ(yaw);
    }
...
public:
     ...
     */
    virtual karto::PointGps GetGpsEstimate(const LocalizedRangeScan* pScan) const = 0;
     ...
     */
    virtual void SetGpsEstimate(const LocalizedRangeScan* pScan, const PointGps& rGpsEstimate) = 0;
     ...
     */
    virtual kt_bool IsGpsEstimateValid(const LocalizedRangeScan* pScan) const = 0;
};
...
public:
    ...
    KARTO_Object(LocalizedRangeScan)
        ...
        : LaserRangeScan(rSensorName, rReadings), m_IsDirty(true), m_IsGpsReadingValid(false), m_IsGpsEstimateValid(false), m_pGpsEstimationManager(NULL)
    {
    }
...
public:
     ...
     */
    inline PointGps GetGpsReading() const
    {
        return m_GpsReading;
    }
     ...
     */
    inline void SetGpsReading(const PointGps& rGpsReading)
    {
     ...
     */
    inline PointGps GetGpsEstimate() const
    {
     ...
     */
    inline void SetGpsEstimate(const PointGps& rGpsEstimate)
    {
        if (m_pGpsEstimationManager != NULL)
        {
